...
export const linkingPrefix = 'homeworkapp://';
...
export class DeepLinking {
  static linking = {
    ...
    static getPathWithoutPrefix = (url) => { let path = '';
      DeepLinking.linking.prefixes.forEach(prefix => { if (url.indexOf(prefix) > -1) {
    ...
    static getActionFromState = (config, url) => { const path = DeepLinking.getPathWithoutPrefix(url);
